...
@ViewScoped
public class RepCoordinadorJSFManagedBean extends BaseJSFManagedBean implements Serializable {

    
    private static final long serialVersionUID = 20120420L;
    private final Long codProfesor;
    private Long anio;
    ...
    public void cicloChangeListener() {
        ...
        if (smreporte.getValue().toString().equalsIgnoreCase("D")) {
            sql.append("SELECT DISTINCT  CONCAT (MATERIA.CODIGO_PROFESOR , '-', MATERIA.CODIGO_ESP), "
                    + " MATERIA.APELLIDO_PROFESOR +' '+MATERIA.NOMBRE_PROFESOR+ ' / '+ programa nombre "
