...
public class EncuestaCalendarioPK implements Serializable {
    ...
    public EncuestaCalendarioPK(Long anio, Long ciclo, Long codigoMateria, Long codigoEncuesta, Long codigoProfesor, Long codigoEsp,
            Long codigoNivel, Long codigoParalelo) {
        this.anio = anio;
        this.ciclo = ciclo;
        this.codigoMateria = codigoMateria;
        this.codigoEncuesta = codigoEncuesta;
    ...
    public int hashCode() {
        ...
        hash = 83 * hash + (this.codigoEncuesta != null ? this.codigoEncuesta.hashCode() : 0);
        hash = 83 * hash + (this.codigoProfesor != null ? this.codigoProfesor.hashCode() : 0);
        hash = 83 * hash + (this.codigoEsp != null ? this.codigoEsp.hashCode() : 0);
        hash = 83 * hash + (this.codigoNivel != null ? this.codigoNivel.hashCode() : 0);
        hash = 83 * hash + (this.codigoParalelo != null ? this.codigoParalelo.hashCode() : 0);
        return hash;
    }
    ...
    public String toString() {
        return "EncuestaCalendarioPK{" + "anio=" + anio + ", ciclo=" + ciclo + ", codigoMateria=" + codigoMateria + ", codigoEncuesta=" + codigoEncuesta + ", codigoProfesor=" + codigoProfesor + ", codigoEsp=" + codigoEsp + ", codigoNivel=" + codigoNivel + ", codigoParalelo=" + codigoParalelo + '}';
    }
