 ...
 */
@Embeddable
public class SylabusBiblioPK implements Serializable {

    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "NUMERO_BIBLIO")
    private Long numeroBiblio;
    ...
    public SylabusBiblioPK() {
    }

    public SylabusBiblioPK(Long numeroBiblio, Long anio, Long ciclo, Long codigoMateria, Long codigoProfesor, Long codigoNivel,
            Long vacCodnum, Long codParalelo, Long codPrograma) {
        this.anio = anio;
        this.ciclo = ciclo;
    ...
    public Long getNumeroBiblio() {
        return numeroBiblio;
    }

    public void setNumeroBiblio(Long numeroBiblio) {
        this.numeroBiblio = numeroBiblio;
    }
    ...
    public int hashCode() {
        int hash = 7;
        hash = 41 * hash + (this.numeroBiblio != null ? this.numeroBiblio.hashCode() : 0);
        hash = 41 * hash + (this.anio != null ? this.anio.hashCode() : 0);
        hash = 41 * hash + (this.ciclo != null ? this.ciclo.hashCode() : 0);
        hash = 41 * hash + (this.codigoMateria != null ? this.codigoMateria.hashCode() : 0);
        hash = 41 * hash + (this.codigoProfesor != null ? this.codigoProfesor.hashCode() : 0);
        hash = 41 * hash + (this.codigoNivel != null ? this.codigoNivel.hashCode() : 0);
        hash = 41 * hash + (this.vacCodnum != null ? this.vacCodnum.hashCode() : 0);
        hash = 41 * hash + (this.codParalelo != null ? this.codParalelo.hashCode() : 0);
        hash = 41 * hash + (this.codPrograma != null ? this.codPrograma.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final SylabusBiblioPK other = (SylabusBiblioPK) obj;
        if (this.numeroBiblio != other.numeroBiblio && (this.numeroBiblio == null || !this.numeroBiblio.equals(other.numeroBiblio))) {
            return false;
        }
    ...
    public String toString() {
        return "SylabusBiblioPK{" + "numeroBiblio=" + numeroBiblio + ", anio=" + anio + ", ciclo=" + ciclo + ", codigoMateria=" + codigoMateria + ", codigoProfesor=" + codigoProfesor + ", codigoNivel=" + codigoNivel + ", vacCodnum=" + vacCodnum  + ", codParalelo=" + codParalelo + ", codPrograma=" + codPrograma + '}';
    }
